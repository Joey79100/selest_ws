	...
	*/
	...
	if($db->database){
		...
		if (
			...
			$pre_adh_id_auteur = $_POST['pre_adh_id_auteur'];
			...
			$query = "INSERT INTO prestation (pre_adh_id_auteur, pre_cat_id, pre_ltp_id, pre_date_souhaitee_debut, pre_date_souhaitee_fin, pre_date_realisation, pre_description, pre_souets)
				VALUES (:pre_adh_id_auteur, :pre_cat_id, :pre_ltp_id, :pre_date_souhaitee_debut, :pre_date_souhaitee_fin, :pre_date_realisation, :pre_description, :pre_souets)";

			// préparation des paramètres
			$parametres = array(
				':pre_adh_id_auteur' => $pre_adh_id_auteur,
